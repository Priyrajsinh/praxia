...
type PagePlaceholderProps = {
  ...
  lede: string;
  /** Which build phase fills this page in â€” keeps the scaffold honest. */
  arrives?: string;
  children?: ReactNode;
};
 ...
 * <h1> in the display face on paper. This is scaffolding, not curriculum â€” the
  ...
  return (
    <article className="max-w-[68ch]">
      ...
      <p className="mt-10 font-mono text-xs uppercase tracking-wider text-faded-ink">
        Placeholder{arrives ? ` â€” authored in ${arrives}` : ""}
      </p>
    </article>
  );
}

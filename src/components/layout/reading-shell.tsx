...
/**
 * The three-rail editorial shell (PROJECT_PLAN Â§3.5) â€” deliberately NOT a
 * centered single column.
 *
 *   â”Œâ”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
 *   â”‚ SPINEâ”‚  READING COLUMN    â”‚  MARGIN RAIL  â”‚
 *   â”‚ (routeâ”‚ (serif body,       â”‚ cross-cutting â”‚
 *   â”‚  line)â”‚  ~68ch, lh 1.7)    â”‚  skills Â§11)  â”‚
 *   â””â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”´â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
 *
 * Desktop: three columns, the left rail holding the hand-drawn route spine.
 * Mobile (below lg): rails collapse â€” the spine is hidden and the margin rail
...
export function ReadingShell({ children }: { children: ReactNode }) {
  return (
    <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-x-10 px-6 lg:grid-cols-[4.5rem_minmax(0,68ch)_minmax(0,1fr)]">
      {/* LEFT â€” the signature hand-drawn route spine (Â§3.4). Desktop only. */}
      <div className="relative hidden lg:block">
        <RouteSpine />
      </div>

      {/* CENTER â€” the reading column. Skip-link + primary landmark target. */}
      <main id="content" className="reading-column min-w-0 py-10 lg:py-16">
        {children}
      </main>

      {/* RIGHT â€” cross-cutting skills sidebar (PROJECT_PLAN Â§11). Sticky on

...
export const metadata: Metadata = {
  title: "Privacy",
  description:
    "Praxia privacy policy — what we collect (almost nothing) and why.",
};
    ...
    <article>
      ...
      <StageSection id="summary" title="Short version">
        ...
        <p>
          ...
          dark/light mode preference and your stage completion state — both
      ...
      <StageSection id="what-we-collect" title="What we collect">
        ...
        <ul>
          ...
          <li>
            Is not associated with any identifier — we have no way to know it is
            yours.
          </li>
        </ul>
        ...
        <p>
          There is no analytics script on this site — no Google Analytics, no
      ...
      <StageSection id="external-links" title="External links">
        <p>
          Praxia links to many external sites — course platforms, book
      ...
      <StageSection id="children" title="Minors">
        <p>
          ...
          for users under 13 or under 16 — there is simply nothing to collect or
          store.
        </p>
      </StageSection>
      ...
      <StageSection id="changes" title="Changes to this policy">
        <p>
          If this policy changes materially — for example, if analytics are
          added or affiliate links are introduced — the change will be announced
          on this page and the &ldquo;last updated&rdquo; date will be revised.
          We will not introduce tracking quietly.
        </p>
      </StageSection>
    </article>
  );
